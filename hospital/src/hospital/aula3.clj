...
; simbolo que qualquer thread que acessar esse namespace vai ter acesse a ele com o valor padrao guilherme
(def nome "guilherme")
...
(let [nome "guilherme"]
  ...
  ; coisa 2
  (println nome)
  ; nao estou refazendo o binding do simbolo do simbolo local
...
(defn testa-atomao []
  (let [hospital-silveira (atom {:espera h.model/fila-vazia})]
    ...
    ;update tradiconal imutavel, com dereferencia, que nao trara efeito
